...
class UI {
    public:
        ...
        const static int TOTAL_FIGURE = 0;
    ...
    private:
        ...
        ui_interface_string_t *ui_g_Ungroup_Bayblade = (&(ui_g_now_strings[0]));
        ui_interface_string_t *ui_g_Ungroup_Flywheel = (&(ui_g_now_strings[1]));
        ui_interface_string_t *ui_g_Ungroup_CV = (&(ui_g_now_strings[2]));
        ui_interface_string_t *ui_g_Ungroup_Alignment = (&(ui_g_now_strings[3]));

        uint8_t *ui_g_Ungroup_Bayblade_send_count = (&(ui_g_dirty_string[0]));
        uint8_t *ui_g_Ungroup_Flywheel_send_count = (&(ui_g_dirty_string[1]));
        uint8_t *ui_g_Ungroup_CV_send_count = (&(ui_g_dirty_string[2]));
